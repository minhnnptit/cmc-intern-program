...
Buổi 2: Define interface + memory implementation
Buổi 3: Add postgres implementation (interface unchanged!)
Buổi 4: Add Filter/Search methods
Buổi 5: Add mock implementation for tests
*/
