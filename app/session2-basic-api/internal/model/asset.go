...
📝 COMPARISON với Buổi 1:

Buổi 1: Không có model layer, struct inline trong main
Buổi 2: Separate model package, reusable

🔄 Evolution trong các buổi tiếp theo:

Buổi 3: Model không thay đổi! (Database agnostic)
Buổi 4: Có thể thêm fields mới (Description, Tags, etc.)
Buổi 5: Model dùng trong tests
Buổi 6: Model serialize ra JSON cho frontend
*/
